<%@ Page Title="" Language="C#" MasterPageFile="~/mpMain.Master" AutoEventWireup="true" CodeBehind="wfAdminPage.aspx.cs" Inherits="MyWebApplication.PagesForAdmins.wfAdminPage" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder4" runat="server">
    ...
    <tr>
        <td style="color: #00FFFF; text-align: center">עמוד האדמין</td>
    </tr>
    <tr>
        <td>
            <asp:GridView ID="gvAdminPage" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" Height="710px" Width="1159px">
